...
const messages = {
  ru: {
    ...
    rights: '© 2022 ООО «Криптек», 2022. Все права защищены<br>Общество с ограниченной ответственностью «Криптек»',
    footerTop: 'ООО Криптек',
  ...
  en: {
    ...
    rights: '©Copyright 2022 Kriptek LLC, 2022. All Rights Reserved<br>Kriptek Limited Liability Company',
